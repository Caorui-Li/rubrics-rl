...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        data = load_dataset(ds_collections[ds_name]["root"], cache_dir=os.path.join(os.getcwd(), "dataset/MathVision"))[
        ...
        cmd = f"python evaluation/mathvision/extract_calculate.py --output_file {results_file} --output_dir {args.out_dir}"
        print(cmd)
