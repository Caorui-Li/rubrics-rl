...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        data = load_dataset(
            ...
            cache_dir=os.path.join(os.getcwd(), "dataset/MathVerse"),
        )[ds_collections[ds_name]["split"]]
        ...
        cmd = f"python evaluation/mathverse/extract_calculate.py --output_file {results_file} --output_dir {args.out_dir}"
        print(cmd)
